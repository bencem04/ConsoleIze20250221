...
class Program
{
    static void Main()
    {
        const string filePath = "C:\\Users\\ny21MiklósB\\Desktop\\Course\\course.txt";
        ...
        Console.WriteLine($"1. Hallgatók: {students.Count}");
        Console.WriteLine($"2. Átlag: {students.Average(s => s.Scores[3]):F2}");
        ...
        Console.WriteLine($"8. Minden modulból 100%: {students.Count(s => s.Scores.All(score => score == 100))}");
